...
export default function GenericAndroidTVCard({
  ...
  const getAppLogo = (app) => {
    ...
    if (linkedActive) {
      ...
      if (appId.includes('jellyfin') || appName.includes('jellyfin'))
        return 'https://cdn.simpleicons.org/jellyfin';
      if (appId.includes('emby') || appName.includes('emby'))
        return 'https://cdn.simpleicons.org/emby';
    }
